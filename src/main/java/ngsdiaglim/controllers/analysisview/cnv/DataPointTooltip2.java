 ...
 */
public class DataPointTooltip2 extends AbstractDataFormattingPlugin {
    /**
     ...
     */
    public DataPointTooltip2(final double pickingDistance) {
        this();
    ...
    protected void updateLabel(final MouseEvent event, final Bounds plotAreaBounds, final DataPoint dataPoint) {
        ...
        if (spaceRight >= width + LABEL_X_OFFSET) { // place to right if enough space
            xLocation = mouseX + LABEL_X_OFFSET;
        ...
        if (height < spaceBottom) {
            ...
            yLocation = mouseY - LABEL_Y_OFFSET - height;
    ...
    public static class DataPoint {
        ...
        private final String formattedLabel; // may be empty
        private final double distanceFromMouse;
