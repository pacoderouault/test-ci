...
public class AddGeneTranscriptSetDialog extends DialogPane.Dialog<AddGeneTranscriptSetDialog.GeneTranscritptSetCreationData> {
    ...
    private String checkErrorForm() {
        if (getValue().getName() == null || StringUtils.isBlank(getValue().getName())) {
            return App.getBundle().getString("addGeneTranscriptSetDialog.msg.err.emptyName");
        }
        else if (getValue().getFile() == null || !getValue().getFile().exists()) {
            return App.getBundle().getString("addGeneTranscriptSetDialog.msg.err.emptyFile");
        }
        else {
            try {
    ...
    public static class GeneTranscritptSetCreationData {
