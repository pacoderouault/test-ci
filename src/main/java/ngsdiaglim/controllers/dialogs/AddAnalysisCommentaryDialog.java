...
public class AddAnalysisCommentaryDialog extends DialogPane.Dialog<AddAnalysisCommentaryDialog.AnalysisCommentaryData> {
    ...
    private String checkError() {
        if (StringUtils.isBlank(commentTa.getText())) {
            return App.getBundle().getString("addanalysiscommentary.msg.err.emptycomment");
        }
        return null;
    }
