...
public class WorkIndicatorDialog<P> {
    ...
    private void setupDialog() {
        stackPane.getStyleClass().add("waitingdialog");
        dialogContainer.getStyleClass().add("waitingdialog-container");
        ...
        dialogContainer.getChildren().addAll(label, progressIndicator);
