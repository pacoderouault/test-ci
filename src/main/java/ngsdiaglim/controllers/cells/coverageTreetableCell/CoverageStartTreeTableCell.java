...
public class CoverageStartTreeTableCell extends TreeTableCell<SpecificCoverageRegion, SpecificCoverageRegion> {
    ...
    protected void updateItem(SpecificCoverageRegion item, boolean empty) {
        ...
        if (item == null || empty) {
            ...
            if (item.getCoverageRegion() == null) {
                ...
                setText(String.valueOf(item.getCoverageRegion().getStart()));
            }
        }
    }
}