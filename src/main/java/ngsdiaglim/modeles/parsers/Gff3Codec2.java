...
public class Gff3Codec2 extends AbstractFeatureCodec<Gff3Feature, LineIterator> {
    ...
    public Gff3Codec2(final DecodeDepth decodeDepth) {
    ...
    private Gff3Feature decode(final LineIterator lineIterator, final DecodeDepth depth) throws IOException {
         ...
         */
        System.out.println("lineIterator == null : " + (lineIterator == null));
        ...
        System.out.println(thisFeature == null);
        System.out.println(thisFeature.isTopLevelFeature());
